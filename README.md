...
# Data preprocessing 
Our next step in our data preprocessing is to compress the size of our matrices by removing the excess 0s and zoning in on the larger numerical values. We will also indentify the peak values in the gaussian distributions in contrast to the ideal values. 
